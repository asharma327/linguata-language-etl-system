...
if __name__ == "__main__":
    ...
    UNITS = None         # e.g. [1, 2, 3]  — auto-selects all vocab questions without images
    ...
    response = requests.post("http://localhost:8000/generate-lesson-images", json=payload)
