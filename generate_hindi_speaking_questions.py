...
if __name__ == "__main__":
    ...
    S3_OUTPUT_PREFIX = "hindi/reading_questions"  # S3 prefix where generated question JSONs are written

    LESSON_TYPE   = "reading"   # generate for all lessons of this type
    LESSON_IDS    = [3318, 3403]         # or specify e.g. [101, 102] to target specific lessons
    ...
    response = requests.post("http://localhost:8010/generate-article-questions", json=payload)
